...
write.csv(lm.s.npc[["result.summary"]], paste0(opts$output, 'ko_MaAsLin2_overall_difference.csv'))
...
write.csv(plot.data, paste0(opts$output, 'ko_MaAsLin2_enriched_depleted.csv'))
